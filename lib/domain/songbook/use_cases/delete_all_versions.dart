...
class DeleteAllVersions {
  ...
  DeleteAllVersions(this._songbookRepository, this._userVersionRepository, this._updateSongbookPreview);
  ...
  Future<Result<void, RequestError>> call(int songbookId) async {
    ...
    final apiResult = await _songbookRepository.deleteVersions(songbookId: songbookId, versionsId: versionsIdList);
