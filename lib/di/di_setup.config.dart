...
import 'package:cifraclub/di/analytics_module.dart' as _i110;
import 'package:cifraclub/di/app_module.dart' as _i96;
import 'package:cifraclub/di/artist_module.dart' as _i111;
import 'package:cifraclub/di/authentication_module.dart' as _i90;
import 'package:cifraclub/di/bottom_sheet_module.dart' as _i112;
import 'package:cifraclub/di/controllers_module.dart' as _i91;
import 'package:cifraclub/di/device_module.dart' as _i103;
import 'package:cifraclub/di/firebase_module.dart' as _i94;
import 'package:cifraclub/di/genre_module.dart' as _i104;
import 'package:cifraclub/di/home_module.dart' as _i106;
import 'package:cifraclub/di/in_app_purchase_module.dart' as _i95;
import 'package:cifraclub/di/isar_module.dart' as _i97;
import 'package:cifraclub/di/list_limit_module.dart' as _i98;
import 'package:cifraclub/di/log_module.dart' as _i99;
import 'package:cifraclub/di/navigator_module.dart' as _i22;
import 'package:cifraclub/di/network_module.dart' as _i92;
import 'package:cifraclub/di/order_module.dart' as _i107;
import 'package:cifraclub/di/path_module.dart' as _i93;
import 'package:cifraclub/di/remote_config_module.dart' as _i101;
import 'package:cifraclub/di/search_module.dart' as _i108;
import 'package:cifraclub/di/shared_preferences_module.dart' as _i102;
import 'package:cifraclub/di/song_module.dart' as _i109;
import 'package:cifraclub/di/songbook_module.dart' as _i105;
import 'package:cifraclub/di/subscription_module.dart' as _i113;
import 'package:cifraclub/di/time_module.dart' as _i100;
...
import 'package:cifraclub/domain/app/use_cases/open_app_or_store.dart' as _i81;
import 'package:cifraclub/domain/artist/repository/artist_repository.dart' as _i69;
import 'package:cifraclub/domain/artist/use_cases/get_top_artists.dart' as _i76;
...
import 'package:cifraclub/domain/genre/use_cases/insert_user_genre.dart' as _i79;
...
import 'package:cifraclub/domain/list_limit/use_cases/get_list_limit_state.dart' as _i89;
import 'package:cifraclub/domain/list_limit/use_cases/get_tabs_limit.dart' as _i47;
import 'package:cifraclub/domain/list_limit/use_cases/get_tabs_limit_state.dart' as _i88;
...
import 'package:cifraclub/domain/search/use_case/search_all_use_case.dart' as _i84;
import 'package:cifraclub/domain/song/repository/song_repository.dart' as _i63;
import 'package:cifraclub/domain/song/use_cases/get_top_songs.dart' as _i77;
...
import 'package:cifraclub/domain/songbook/use_cases/insert_user_songbook.dart' as _i80;
import 'package:cifraclub/domain/songbook/use_cases/refresh_all_songbooks.dart' as _i83;
...
import 'package:cifraclub/domain/subscription/repository/in_app_purchase_repository.dart' as _i78;
import 'package:cifraclub/domain/subscription/repository/order_repository.dart' as _i56;
import 'package:cifraclub/domain/subscription/repository/subscription_repository.dart' as _i85;
import 'package:cifraclub/domain/subscription/use_cases/get_orders.dart' as _i75;
import 'package:cifraclub/domain/subscription/use_cases/get_pro_status_stream.dart' as _i86;
...
import 'package:cifraclub/domain/subscription/use_cases/purchase_product.dart' as _i82;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i60.SetIsProPreference>(() => _i60.SetIsProPreference(get<_i29.SharedPreferencesRepository>()));
  gh.factory<_i61.SetUserGenres>(() => _i61.SetUserGenres(genresRepository: get<_i39.GenresRepository>()));
  gh.factory<_i62.SongDataSource>(() => songModule.getSongDataSource(get<_i36.CifraClubAPINetworkService>()));
  ...
  gh.factory<_i67.AnalyticsRepository>(() => analyticsModule.getAnalyticsRepository(get<_i37.FirebaseAnalytics>()));
  gh.factory<_i68.ArtistDataSource>(() => artistModule.getGenresDataSource(get<_i36.CifraClubAPINetworkService>()));
  ...
  gh.factory<_i71.DevBottomSheet>(() => bottomSheetModule.getDevBottomSheet(get<_i42.GetGenres>()));
  gh.factory<_i72.GenreBottomSheet>(() => bottomSheetModule.getGenreBottomSheet(get<_i42.GetGenres>()));
  gh.factory<_i73.GetAllSongbooks>(() => _i73.GetAllSongbooks(get<_i65.SongbookRepository>()));
  gh.factory<_i74.GetHomeInfo>(() => _i74.GetHomeInfo(get<_i53.HomeRepository>()));
  gh.factory<_i75.GetOrders>(() => _i75.GetOrders(get<_i56.OrderRepository>()));
  gh.factory<_i76.GetTopArtists>(() => _i76.GetTopArtists(artistRepository: get<_i69.ArtistRepository>()));
  gh.factory<_i77.GetTopSongs>(() => _i77.GetTopSongs(songRepository: get<_i63.SongRepository>()));
  gh.factory<_i78.InAppPurchaseRepository>(() => inAppPurchaseModule.getInAppPurchaseRepository(
        get<_i14.InAppPurchaseDataSource>(),
        get<_i57.PostPurchaseOrder>(),
        get<_i75.GetOrders>(),
      ));
  gh.factory<_i79.InsertUserGenre>(() => _i79.InsertUserGenre(
        getUserGenresAsStream: get<_i51.GetUserGenresAsStream>(),
        setUserGenres: get<_i61.SetUserGenres>(),
      ));
  gh.factory<_i80.InsertUserSongbook>(() => _i80.InsertUserSongbook(
        get<_i65.SongbookRepository>(),
        get<_i34.UserSongbookRepository>(),
      ));
  gh.factory<_i81.OpenAppOrStore>(() => _i81.OpenAppOrStore(
  ...
  gh.factory<_i82.PurchaseProduct>(() => _i82.PurchaseProduct(get<_i78.InAppPurchaseRepository>()));
  gh.factory<_i83.RefreshAllSongbooks>(() => _i83.RefreshAllSongbooks(
        get<_i65.SongbookRepository>(),
        get<_i34.UserSongbookRepository>(),
      ));
  gh.factory<_i84.SearchAll>(() => _i84.SearchAll(searchRepository: get<_i59.SearchRepository>()));
  gh.singleton<_i85.SubscriptionRepository>(subscriptionModule.getSubscriptionRepository(
    get<_i78.InAppPurchaseRepository>(),
    get<_i44.GetIsProPreference>(),
    get<_i60.SetIsProPreference>(),
  ));
  gh.factory<_i86.GetProStatusStream>(() => _i86.GetProStatusStream(get<_i85.SubscriptionRepository>()));
  gh.factory<_i87.GetProducts>(() => _i87.GetProducts(get<_i78.InAppPurchaseRepository>()));
  gh.factory<_i88.GetTabsLimitState>(() => _i88.GetTabsLimitState(
        get<_i49.GetTotalSongbookCifras>(),
        get<_i47.GetTabsLimit>(),
        get<_i86.GetProStatusStream>(),
        get<_i18.ListLimitConstants>(),
      ));
  gh.factory<_i89.GetListLimitState>(() => _i89.GetListLimitState(
...
class _$AuthenticationModule extends _i90.AuthenticationModule {}

class _$ControllersModule extends _i91.ControllersModule {}

class _$NavigatorModule extends _i22.NavigatorModule {}

class _$NetworkModule extends _i92.NetworkModule {}

class _$PathModule extends _i93.PathModule {}

class _$FirebaseModule extends _i94.FirebaseModule {}

class _$InAppPurchaseModule extends _i95.InAppPurchaseModule {}

class _$AppModule extends _i96.AppModule {}

class _$IsarModule extends _i97.IsarModule {}

class _$ListLimitModule extends _i98.ListLimitModule {}

class _$LogModule extends _i99.LogModule {}

class _$TimeModule extends _i100.TimeModule {}

class _$RemoteConfigModule extends _i101.RemoteConfigModule {}

class _$SharedPreferencesModule extends _i102.SharedPreferencesModule {}

class _$DeviceModule extends _i103.DeviceModule {}

class _$GenreModule extends _i104.GenreModule {}

class _$SongbookModule extends _i105.SongbookModule {}

class _$HomeModule extends _i106.HomeModule {}

class _$OrderModule extends _i107.OrderModule {}

class _$SearchModule extends _i108.SearchModule {}

class _$SongModule extends _i109.SongModule {}

class _$AnalyticsModule extends _i110.AnalyticsModule {}

class _$ArtistModule extends _i111.ArtistModule {}

class _$BottomSheetModule extends _i112.BottomSheetModule {}

class _$SubscriptionModule extends _i113.SubscriptionModule {}
