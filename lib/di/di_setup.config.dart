...
import 'package:cifraclub/data/search/data_source/search_data_source.dart' as _i52;
import 'package:cifraclub/data/song/data_source/song_data_source.dart' as _i55;
...
import 'package:cifraclub/di/analytics_module.dart' as _i87;
import 'package:cifraclub/di/app_module.dart' as _i75;
import 'package:cifraclub/di/artist_module.dart' as _i88;
import 'package:cifraclub/di/authentication_module.dart' as _i69;
import 'package:cifraclub/di/bottom_sheet_module.dart' as _i89;
import 'package:cifraclub/di/controllers_module.dart' as _i70;
import 'package:cifraclub/di/device_module.dart' as _i81;
import 'package:cifraclub/di/firebase_module.dart' as _i73;
import 'package:cifraclub/di/genre_module.dart' as _i82;
import 'package:cifraclub/di/home_module.dart' as _i83;
import 'package:cifraclub/di/in_app_purchase_module.dart' as _i74;
import 'package:cifraclub/di/isar_module.dart' as _i76;
import 'package:cifraclub/di/log_module.dart' as _i77;
import 'package:cifraclub/di/navigator_module.dart' as _i25;
import 'package:cifraclub/di/network_module.dart' as _i71;
import 'package:cifraclub/di/order_module.dart' as _i84;
import 'package:cifraclub/di/path_module.dart' as _i72;
import 'package:cifraclub/di/remote_config_module.dart' as _i79;
import 'package:cifraclub/di/search_module.dart' as _i85;
import 'package:cifraclub/di/song_module.dart' as _i86;
import 'package:cifraclub/di/subscription_module.dart' as _i80;
import 'package:cifraclub/di/time_module.dart' as _i78;
...
import 'package:cifraclub/domain/app/use_cases/open_app_or_store.dart' as _i67;
...
import 'package:cifraclub/domain/genre/use_cases/set_user_genre.dart' as _i54;
...
import 'package:cifraclub/domain/search/repository/search_repository.dart' as _i53;
import 'package:cifraclub/domain/search/use_case/search_all_use_case.dart' as _i68;
import 'package:cifraclub/domain/song/repository/song_repository.dart' as _i56;
...
import 'package:cifraclub/domain/subscription/use_cases/post_purchase_order.dart' as _i51;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i51.PostPurchaseOrder>(() => _i51.PostPurchaseOrder(get<_i50.OrderRepository>()));
  gh.factory<_i52.SearchDataSource>(() => searchModule.getGenresDataSource(get<_i36.CifraClubAPINetworkService>()));
  gh.factory<_i53.SearchRepository>(() => searchModule.getGenresRepository(get<_i52.SearchDataSource>()));
  gh.factory<_i54.SetUserGenres>(() => _i54.SetUserGenres(genresRepository: get<_i39.GenresRepository>()));
  gh.factory<_i55.SongDataSource>(() => songModule.getSongDataSource(get<_i36.CifraClubAPINetworkService>()));
  gh.factory<_i56.SongRepository>(() => songModule.getSongRepository(get<_i55.SongDataSource>()));
  gh.factory<_i57.AnalyticsRepository>(() => analyticsModule.getAnalyticsRepository(get<_i37.FirebaseAnalytics>()));
  gh.factory<_i58.ArtistDataSource>(() => artistModule.getGenresDataSource(get<_i36.CifraClubAPINetworkService>()));
  gh.factory<_i59.ArtistRepository>(() => artistModule.getGenresRepository(get<_i58.ArtistDataSource>()));
  gh.factory<_i60.DevBottomSheet>(() => bottomSheetModule.getDevBottomSheet(get<_i41.GetGenres>()));
  gh.factory<_i61.GenreBottomSheet>(() => bottomSheetModule.getGenreBottomSheet(get<_i41.GetGenres>()));
  gh.factory<_i62.GetHomeInfo>(() => _i62.GetHomeInfo(get<_i47.HomeRepository>()));
  gh.factory<_i63.GetOrders>(() => _i63.GetOrders(get<_i50.OrderRepository>()));
  gh.factory<_i64.GetTopArtists>(() => _i64.GetTopArtists(artistRepository: get<_i59.ArtistRepository>()));
  gh.factory<_i65.GetTopSongs>(() => _i65.GetTopSongs(songRepository: get<_i56.SongRepository>()));
  gh.factory<_i66.InsertUserGenre>(() => _i66.InsertUserGenre(
        getUserGenresAsStream: get<_i45.GetUserGenresAsStream>(),
        setUserGenres: get<_i54.SetUserGenres>(),
      ));
  gh.factory<_i67.OpenAppOrStore>(() => _i67.OpenAppOrStore(
  ...
  gh.factory<_i68.SearchAll>(() => _i68.SearchAll(searchRepository: get<_i53.SearchRepository>()));
  return get;
}

class _$AuthenticationModule extends _i69.AuthenticationModule {}

class _$ControllersModule extends _i70.ControllersModule {}

class _$NavigatorModule extends _i25.NavigatorModule {}

class _$NetworkModule extends _i71.NetworkModule {}

class _$PathModule extends _i72.PathModule {}

class _$FirebaseModule extends _i73.FirebaseModule {}

class _$InAppPurchaseModule extends _i74.InAppPurchaseModule {}

class _$AppModule extends _i75.AppModule {}

class _$IsarModule extends _i76.IsarModule {}

class _$LogModule extends _i77.LogModule {}

class _$TimeModule extends _i78.TimeModule {}

class _$RemoteConfigModule extends _i79.RemoteConfigModule {}

class _$SubscriptionModule extends _i80.SubscriptionModule {}

class _$DeviceModule extends _i81.DeviceModule {}

class _$GenreModule extends _i82.GenreModule {}

class _$HomeModule extends _i83.HomeModule {}

class _$OrderModule extends _i84.OrderModule {}

class _$SearchModule extends _i85.SearchModule {}

class _$SongModule extends _i86.SongModule {}

class _$AnalyticsModule extends _i87.AnalyticsModule {}

class _$ArtistModule extends _i88.ArtistModule {}

class _$BottomSheetModule extends _i89.BottomSheetModule {}
