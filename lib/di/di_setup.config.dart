...
import 'package:cifraclub/di/analytics_module.dart' as _i131;
import 'package:cifraclub/di/app_module.dart' as _i116;
import 'package:cifraclub/di/artist_module.dart' as _i132;
import 'package:cifraclub/di/authentication_module.dart' as _i110;
import 'package:cifraclub/di/bottom_sheet_module.dart' as _i133;
import 'package:cifraclub/di/cifra_module.dart' as _i123;
import 'package:cifraclub/di/controllers_module.dart' as _i111;
import 'package:cifraclub/di/device_module.dart' as _i122;
import 'package:cifraclub/di/firebase_module.dart' as _i114;
import 'package:cifraclub/di/genre_module.dart' as _i124;
import 'package:cifraclub/di/home_module.dart' as _i127;
import 'package:cifraclub/di/in_app_purchase_module.dart' as _i115;
import 'package:cifraclub/di/isar_module.dart' as _i117;
import 'package:cifraclub/di/log_module.dart' as _i118;
import 'package:cifraclub/di/navigator_module.dart' as _i22;
import 'package:cifraclub/di/network_module.dart' as _i112;
import 'package:cifraclub/di/order_module.dart' as _i128;
import 'package:cifraclub/di/path_module.dart' as _i113;
import 'package:cifraclub/di/remote_config_module.dart' as _i120;
import 'package:cifraclub/di/search_module.dart' as _i129;
import 'package:cifraclub/di/shared_preferences_module.dart' as _i121;
import 'package:cifraclub/di/song_module.dart' as _i130;
import 'package:cifraclub/di/songbook_module.dart' as _i125;
import 'package:cifraclub/di/subscription_module.dart' as _i126;
import 'package:cifraclub/di/time_module.dart' as _i119;
...
import 'package:cifraclub/domain/app/use_cases/open_app_or_store.dart' as _i100;
...
import 'package:cifraclub/domain/artist/use_cases/get_artist_info.dart' as _i86;
import 'package:cifraclub/domain/artist/use_cases/get_artist_songs.dart' as _i87;
import 'package:cifraclub/domain/artist/use_cases/get_artist_video_lessons.dart' as _i88;
...
import 'package:cifraclub/domain/genre/use_cases/insert_user_genre.dart' as _i98;
...
import 'package:cifraclub/domain/home/use_cases/get_home_info.dart' as _i89;
import 'package:cifraclub/domain/list_limit/use_cases/get_list_limit.dart' as _i90;
import 'package:cifraclub/domain/list_limit/use_cases/get_list_limit_state.dart' as _i108;
import 'package:cifraclub/domain/list_limit/use_cases/get_tabs_limit.dart' as _i94;
import 'package:cifraclub/domain/list_limit/use_cases/get_tabs_limit_state.dart' as _i95;
import 'package:cifraclub/domain/list_limit/use_cases/get_tabs_limit_state_by_count.dart' as _i109;
...
import 'package:cifraclub/domain/search/use_case/search_all_use_case.dart' as _i103;
...
import 'package:cifraclub/domain/songbook/use_cases/insert_user_songbook.dart' as _i99;
import 'package:cifraclub/domain/songbook/use_cases/refresh_all_songbooks.dart' as _i102;
...
import 'package:cifraclub/domain/subscription/use_cases/get_pro_status_stream.dart' as _i92;
...
import 'package:cifraclub/domain/subscription/use_cases/purchase_product.dart' as _i101;
import 'package:cifraclub/domain/subscription/use_cases/validate_purchase.dart' as _i104;
import 'package:cifraclub/domain/subscription/use_cases/validate_purchases.dart' as _i105;
import 'package:cifraclub/domain/subscription/use_cases/verify_pro_status.dart' as _i39;
import 'package:cifraclub/domain/subscription/use_cases/watch_for_purchases.dart' as _i106;
import 'package:cifraclub/domain/subscription/use_cases/watch_for_subscriptions.dart' as _i107;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i86.GetArtistInfo>(() => _i86.GetArtistInfo(artistRepository: get<_i81.ArtistRepository>()));
  gh.factory<_i87.GetArtistSongs>(() => _i87.GetArtistSongs(artistRepository: get<_i81.ArtistRepository>()));
  gh.factory<_i88.GetArtistVideoLessons>(() => _i88.GetArtistVideoLessons(get<_i81.ArtistRepository>()));
  gh.factory<_i89.GetHomeInfo>(() => _i89.GetHomeInfo(get<_i59.HomeRepository>()));
  gh.factory<_i90.GetListLimit>(() => _i90.GetListLimit(get<_i50.GetListLimitConstants>()));
  gh.factory<_i91.GetOrders>(() => _i91.GetOrders(get<_i62.OrderRepository>()));
  gh.factory<_i92.GetProStatusStream>(() => _i92.GetProStatusStream(get<_i74.SubscriptionRepository>()));
  gh.factory<_i93.GetRemoteProStatus>(() => subscriptionModule.getRemoteProStatus(get<_i91.GetOrders>()));
  gh.factory<_i94.GetTabsLimit>(() => _i94.GetTabsLimit(get<_i53.GetTabsLimitConstants>()));
  gh.factory<_i95.GetTabsLimitState>(() => _i95.GetTabsLimitState(
        get<_i55.GetTotalSongbookCifras>(),
        get<_i94.GetTabsLimit>(),
        get<_i92.GetProStatusStream>(),
  ...
  gh.factory<_i98.InsertUserGenre>(() => _i98.InsertUserGenre(
        getUserGenresAsStream: get<_i57.GetUserGenresAsStream>(),
        setUserGenres: get<_i68.SetUserGenres>(),
      ));
  gh.factory<_i99.InsertUserSongbook>(() => _i99.InsertUserSongbook(
        get<_i73.SongbookRepository>(),
        get<_i37.UserSongbookRepository>(),
      ));
  gh.factory<_i100.OpenAppOrStore>(() => _i100.OpenAppOrStore(
  ...
  gh.factory<_i101.PurchaseProduct>(() => _i101.PurchaseProduct(
        get<_i15.InAppPurchaseRepository>(),
        get<_i74.SubscriptionRepository>(),
      ));
  gh.factory<_i102.RefreshAllSongbooks>(() => _i102.RefreshAllSongbooks(
        get<_i73.SongbookRepository>(),
        get<_i37.UserSongbookRepository>(),
        get<_i34.UserCifraRepository>(),
        get<_i76.UpdateSongbookPreview>(),
      ));
  gh.factory<_i103.SearchAll>(() => _i103.SearchAll(searchRepository: get<_i65.SearchRepository>()));
  gh.factory<_i104.ValidatePurchase>(() => inAppPurchaseModule.getValidatePurchase(
        get<_i10.GetCredential>(),
        get<_i63.PostPurchaseOrder>(),
        get<_i78.ValidatePurchaseRepository>(),
      ));
  gh.factory<_i105.ValidatePurchases>(() => inAppPurchaseModule.getValidatePurchases(
        get<_i104.ValidatePurchase>(),
        get<_i41.CompletePurchase>(),
      ));
  gh.singleton<_i106.WatchForPurchases>(inAppPurchaseModule.getWatchForPurchases(
    get<_i15.InAppPurchaseRepository>(),
    get<_i74.SubscriptionRepository>(),
    get<_i105.ValidatePurchases>(),
  ));
  gh.singleton<_i107.WatchForSubscriptions>(subscriptionModule.getWatchForSubscriptions(
    get<_i11.GetCredentialStream>(),
    get<_i74.SubscriptionRepository>(),
    get<_i15.InAppPurchaseRepository>(),
    get<_i93.GetRemoteProStatus>(),
  ));
  gh.factory<_i108.GetListLimitState>(() => _i108.GetListLimitState(
        get<_i56.GetTotalSongbooks>(),
        get<_i92.GetProStatusStream>(),
        get<_i90.GetListLimit>(),
        get<_i50.GetListLimitConstants>(),
      ));
  gh.factory<_i109.GetTabLimitStateByCount>(() => _i109.GetTabLimitStateByCount(
        get<_i94.GetTabsLimit>(),
        get<_i53.GetTabsLimitConstants>(),
      ));
  return get;
...
class _$AuthenticationModule extends _i110.AuthenticationModule {}

class _$ControllersModule extends _i111.ControllersModule {}

class _$NavigatorModule extends _i22.NavigatorModule {}

class _$NetworkModule extends _i112.NetworkModule {}

class _$PathModule extends _i113.PathModule {}

class _$FirebaseModule extends _i114.FirebaseModule {}

class _$InAppPurchaseModule extends _i115.InAppPurchaseModule {}

class _$AppModule extends _i116.AppModule {}

class _$IsarModule extends _i117.IsarModule {}

class _$LogModule extends _i118.LogModule {}

class _$TimeModule extends _i119.TimeModule {}
...
class _$DeviceModule extends _i122.DeviceModule {}

class _$CifraModule extends _i123.CifraModule {}

class _$GenreModule extends _i124.GenreModule {}

class _$SongbookModule extends _i125.SongbookModule {}

class _$SubscriptionModule extends _i126.SubscriptionModule {}

class _$HomeModule extends _i127.HomeModule {}

class _$OrderModule extends _i128.OrderModule {}

class _$SearchModule extends _i129.SearchModule {}

class _$SongModule extends _i130.SongModule {}

class _$AnalyticsModule extends _i131.AnalyticsModule {}

class _$ArtistModule extends _i132.ArtistModule {}

class _$BottomSheetModule extends _i133.BottomSheetModule {}
