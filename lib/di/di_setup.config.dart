...
import 'package:cifraclub/data/artist/data_source/artist_data_source.dart' as _i28;
...
import 'package:cifraclub/di/analytics_module.dart' as _i38;
import 'package:cifraclub/di/artist_module.dart' as _i39;
import 'package:cifraclub/di/authentication_module.dart' as _i31;
import 'package:cifraclub/di/firebase_module.dart' as _i33;
import 'package:cifraclub/di/genre_module.dart' as _i37;
import 'package:cifraclub/di/log_module.dart' as _i34;
import 'package:cifraclub/di/navigator_module.dart' as _i13;
import 'package:cifraclub/di/network_module.dart' as _i32;
import 'package:cifraclub/di/remote_config_module.dart' as _i36;
import 'package:cifraclub/di/time_module.dart' as _i35;
import 'package:cifraclub/domain/analytics/repository/analytics_repository.dart' as _i27;
import 'package:cifraclub/domain/artist/repository/artist_repository.dart' as _i29;
import 'package:cifraclub/domain/artist/use_cases/get_top_artists.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i27.AnalyticsRepository>(() => analyticsModule.getAnalyticsRepository(get<_i20.FirebaseAnalytics>()));
  gh.factory<_i28.ArtistDataSource>(() => artistModule.getGenresDataSource(get<_i19.CifraClubAPINetworkService>()));
  gh.factory<_i29.ArtistRepository>(() => artistModule.getGenresRepository(get<_i28.ArtistDataSource>()));
  gh.factory<_i30.GetTopArtists>(() => _i30.GetTopArtists(artistRepository: get<_i29.ArtistRepository>()));
  return get;
}
...
class _$LogModule extends _i34.LogModule {}

class _$TimeModule extends _i35.TimeModule {}

class _$RemoteConfigModule extends _i36.RemoteConfigModule {}

class _$GenreModule extends _i37.GenreModule {}

class _$AnalyticsModule extends _i38.AnalyticsModule {}

class _$ArtistModule extends _i39.ArtistModule {}
