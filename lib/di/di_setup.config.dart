...
import 'package:cifraclub/data/artist/data_source/artist_data_source.dart' as _i40;
...
import 'package:cifraclub/data/search/data_source/search_data_source.dart' as _i34;
import 'package:cifraclub/data/song/data_source/song_data_source.dart' as _i37;
import 'package:cifraclub/data/time/data_source/ntp_data_source.dart' as _i19;
import 'package:cifraclub/di/analytics_module.dart' as _i57;
import 'package:cifraclub/di/artist_module.dart' as _i58;
import 'package:cifraclub/di/authentication_module.dart' as _i46;
import 'package:cifraclub/di/firebase_module.dart' as _i49;
import 'package:cifraclub/di/genre_module.dart' as _i54;
import 'package:cifraclub/di/isar_module.dart' as _i50;
import 'package:cifraclub/di/log_module.dart' as _i51;
import 'package:cifraclub/di/navigator_module.dart' as _i18;
import 'package:cifraclub/di/network_module.dart' as _i47;
import 'package:cifraclub/di/path_module.dart' as _i48;
import 'package:cifraclub/di/remote_config_module.dart' as _i53;
import 'package:cifraclub/di/search_module.dart' as _i55;
import 'package:cifraclub/di/song_module.dart' as _i56;
import 'package:cifraclub/di/time_module.dart' as _i52;
import 'package:cifraclub/domain/analytics/repository/analytics_repository.dart' as _i39;
import 'package:cifraclub/domain/artist/repository/artist_repository.dart' as _i41;
import 'package:cifraclub/domain/artist/use_cases/get_top_artists.dart' as _i42;
...
import 'package:cifraclub/domain/genre/use_cases/insert_user_genre.dart' as _i44;
import 'package:cifraclub/domain/genre/use_cases/set_user_genre.dart' as _i36;
...
import 'package:cifraclub/domain/search/repository/search_repository.dart' as _i35;
import 'package:cifraclub/domain/search/use_case/search_all_use_case.dart' as _i45;
import 'package:cifraclub/domain/song/repository/song_repository.dart' as _i38;
import 'package:cifraclub/domain/song/use_cases/get_top_songs.dart' as _i43;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i34.SearchDataSource>(() => searchModule.getGenresDataSource(get<_i25.CifraClubAPINetworkService>()));
  gh.factory<_i35.SearchRepository>(() => searchModule.getGenresRepository(get<_i34.SearchDataSource>()));
  gh.factory<_i36.SetUserGenres>(() => _i36.SetUserGenres(genresRepository: get<_i28.GenresRepository>()));
  gh.factory<_i37.SongDataSource>(() => songModule.getSongDataSource(get<_i25.CifraClubAPINetworkService>()));
  gh.factory<_i38.SongRepository>(() => songModule.getSongRepository(get<_i37.SongDataSource>()));
  gh.factory<_i39.AnalyticsRepository>(() => analyticsModule.getAnalyticsRepository(get<_i26.FirebaseAnalytics>()));
  gh.factory<_i40.ArtistDataSource>(() => artistModule.getGenresDataSource(get<_i25.CifraClubAPINetworkService>()));
  gh.factory<_i41.ArtistRepository>(() => artistModule.getGenresRepository(get<_i40.ArtistDataSource>()));
  gh.factory<_i42.GetTopArtists>(() => _i42.GetTopArtists(artistRepository: get<_i41.ArtistRepository>()));
  gh.factory<_i43.GetTopSongs>(() => _i43.GetTopSongs(songRepository: get<_i38.SongRepository>()));
  gh.factory<_i44.InsertUserGenre>(() => _i44.InsertUserGenre(
        getUserGenresAsStream: get<_i33.GetUserGenresAsStream>(),
        setUserGenres: get<_i36.SetUserGenres>(),
      ));
  gh.factory<_i45.SearchAll>(() => _i45.SearchAll(searchRepository: get<_i35.SearchRepository>()));
  return get;
}

class _$AuthenticationModule extends _i46.AuthenticationModule {}
...
class _$LogModule extends _i51.LogModule {}

class _$TimeModule extends _i52.TimeModule {}

class _$RemoteConfigModule extends _i53.RemoteConfigModule {}

class _$GenreModule extends _i54.GenreModule {}

class _$SearchModule extends _i55.SearchModule {}

class _$SongModule extends _i56.SongModule {}

class _$AnalyticsModule extends _i57.AnalyticsModule {}

class _$ArtistModule extends _i58.ArtistModule {}
