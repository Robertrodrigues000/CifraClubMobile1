...
class HomeTopCifras extends StatefulWidget {
  const HomeTopCifras({
  ...
  @override
  State<HomeTopCifras> createState() => _HomeTopCifrasState();
}

class _HomeTopCifrasState extends State<HomeTopCifras> {
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: context.appDimensionScheme.topCifrasItemsPerRow, mainAxisExtent: (2 * textHeight) + 32),
