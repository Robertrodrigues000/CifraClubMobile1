...
ArtistSearch getFakeArtistSearch() => ArtistSearch(id: faker.randomGenerator.integer(1000), name: faker.address.person.name(), url: faker.address.person.firstName(), imageUrl: faker.image.image());
