...
class LogRepositoryMock extends Mock implements LogRepository {
  static LogRepositoryMock getDummy() {
    ...
    when(() => logRepository.log(
        tag: any(named: "tag"),
        message: any(named: "message"),
        level: any(named: "level"),
        error: any(named: "error"),
        stackTrace: any(named: "stackTrace"))).thenAnswer((invocation) => Future.value(null));
    ...
    when(() => logRepository.setCustomKey(key: any(named: "key"), value: any(named: "value")))
